                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('cp.index')}}">الرئيسية </a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('cp.languages')}}"> أللغات </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('cp.languages.update',$language)}}" method="POST"
